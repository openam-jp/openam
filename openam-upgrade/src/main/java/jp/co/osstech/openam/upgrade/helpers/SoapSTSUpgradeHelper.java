...
/**
 * This upgrade helper adjusts SoapSecurityTokenService schema.
 */
public class SoapSTSUpgradeHelper extends AbstractUpgradeHelper {
    ...
    private static final String SOAP_ENCRYPTION_KEY_ALIAS = "soap-encryption-key-alias";
    private static final String SOAP_SIGNATURE_KEY_ALIAS = "soap-signature-key-alias";
    private static final String SOAP_SIGNATURE_KEY_PASSWORD = "soap-signature-key-password";
    private static final String SOAP_ENCRYPTION_KEY_PASSWORD = "soap-encryption-key-password";
    ...
    public SoapSTSUpgradeHelper() {
        attributes.add(PERSIST_ISSUED_TOKENS_IN_CTS);
        attributes.add("issued-token-types");
        attributes.add(SharedSTSConstants.SECURITY_POLICY_VALIDATED_TOKEN_CONFIG);
        attributes.add(SharedSTSConstants.SERVICE_QNAME);
        attributes.add(SharedSTSConstants.CUSTOM_SERVICE_QNAME);
        attributes.add(SharedSTSConstants.PORT_QNAME);
        attributes.add(SharedSTSConstants.CUSTOM_PORT_QNAME);
        attributes.add(SharedSTSConstants.WSDL_LOCATION);
        attributes.add(SharedSTSConstants.CUSTOM_WSDL_LOCATION);
        attributes.add(SharedSTSConstants.AM_DEPLOYMENT_URL);
        ...
        attributes.add(SharedSTSConstants.DELEGATION_RELATIONSHIP_SUPPORTED);
        attributes.add(SharedSTSConstants.DELEGATION_TOKEN_VALIDATORS);
        attributes.add(SharedSTSConstants.CUSTOM_DELEGATION_TOKEN_HANDLERS);
        attributes.add(SOAP_KEYSTORE_FILENAME);
        attributes.add(SOAP_KEYSTORE_PASSWORD);
        attributes.add(SOAP_ENCRYPTION_KEY_ALIAS);
        attributes.add(SOAP_SIGNATURE_KEY_ALIAS);
        attributes.add(SOAP_SIGNATURE_KEY_PASSWORD);
        attributes.add(SOAP_ENCRYPTION_KEY_PASSWORD);
