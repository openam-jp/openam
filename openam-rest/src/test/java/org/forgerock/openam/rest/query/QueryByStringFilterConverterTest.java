...
public class QueryByStringFilterConverterTest {
    ...
    public void shouldCreateAndFilter() {
        ...
        when(mockConverter.visitAndFilter(nullable(Void.class), ArgumentMatchers.<QueryFilter<JsonPointer>>anyList())).thenCallRealMethod();
    ...
    public void shouldCreateOrFilter() {
        ...
        QueryByStringFilterConverter mockConverter = mock(QueryByStringFilterConverter.class);
        ArgumentCaptor<List> captor = ArgumentCaptor.forClass(List.class);
        when(mockConverter.visitOrFilter(nullable(Void.class), ArgumentMatchers.<QueryFilter<JsonPointer>>anyList())).thenCallRealMethod();
        ...
        verify(mockConverter, times(1)).visitEqualsFilter(nullable(Void.class), any(JsonPointer.class), any());
        verify(mockConverter, times(1)).visitContainsFilter(nullable(Void.class), any(JsonPointer.class), any());
    }
